...
const ServiceCard = ({ subtitle, title, description, image, isHovered, onHover, onLeave }: ServiceCardProps) => {
    return (
        <motion.div
            ...
            <div className="relative z-10 h-full flex items-center py-8 md:py-10 px-6 md:px-8">
                ...
                {!isHovered && (
                    <div className="flex items-center justify-between w-full">
                        ...
                        {/* Right - Learn More Text */}
                        {/* <motion.div
                            className="flex items-center gap-2 text-gray-400 text-sm md:text-base gotham"
                            initial={{ opacity: 1 }}
                            exit={{ opacity: 0 }}
                        >
    ...
    const services = [
        {
            ...
            description: 'Whether you\'re a UK non-dom, an executive on assignment in Europe, or an entrepreneur with international income streams, we provide clarity. We handle residency issues, double-taxation treaties, and strategic planning to ensure your personal wealth is protected and compliant.',
            image: '/assets/sv1.png'
        },
        {
            subtitle: 'For the Ambitious Enterprise:',
            title: 'Corporate Tax',
            description: 'Expansion should be a catalyst for growth, not a tax headache. We assist in structuring your company for tax-efficient cross-border operations, managing transfer pricing, and ensuring you meet all legal obligations in the UK and EU.',
            image: '/assets/sv2.png'
        },
        {
            subtitle: 'For Seamless Cross-Border Trade:',
            title: 'Value-Added Tax (VAT)',
            description: 'VAT is one of the most complex areas of international business. Our advisory ensures your supply chain is structured efficiently, you are compliant with all regulations, and you avoid costly errors.',
