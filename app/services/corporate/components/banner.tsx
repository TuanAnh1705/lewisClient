        ...
        <div className="md:-mb-10">
            ...
            <section className="relative h-[500px] flex items-center justify-center overflow-hidden">
                ...
                <div className="absolute inset-0 z-0 bg-[#041122]">
                    <Image
                        src="/assets/sv10.png" // Replace with your image path
                ...
                <div className="relative z-10 flex flex-col items-center text-center px-4">
                    <h1 className="trajan-pro text-3xl md:text-5xl lg:text-5xl lg:max-w-3xl font-medium text-white ">
                       Strategic Corporate Tax Structuring
                    </h1>
                    
                    {/* THAY ĐỔI Ở ĐÂY: Thêm 'mt-6' */}
                    <p className='arial-nova lg:max-w-3xl font-medium text-md md:text-lg lg:text-xl text-white mt-5 md:mt-16'>
                       Fueling your international growth with tax-efficient and compliant frameworks.
                    </p>
                </div>
            </section>
        </div>
