  ...
  return (
    <div className="container mx-auto px-4">
      <div className="relative z-10 -mt-10 max-w-4xl md:max-w-5xl mx-auto bg-[#F2F0EC] p-6 sm:p-10 md:p-16 rounded-lg shadow-xl overflow-hidden">
        ...
        <div className="flex flex-col md:flex-row items-center md:items-start gap-6 sm:gap-10 md:gap-12">

          {/* Avatar */}
          <div className="flex shrink-0 justify-center md:justify-start">
            <Avatar className="h-36 w-36 sm:h-44 sm:w-44 md:h-64 md:w-64">
              <AvatarImage
          ...
          <div className="text-gray-800 text-center md:text-left px-2">
            <h2 className="trajan-pro text-xl sm:text-2xl md:text-3xl font-medium text-[#041122] leading-snug tracking-tight">
              LSJ TAX - Your Strategic Partner in International Tax
            </h2>

            <h3 className="gotham text-lg sm:text-xl font-medium mt-2 text-[#BC9750]">
              Lewis
            </h3>

            <p className="arial-nova mt-4 sm:mt-6 text-sm sm:text-base text-[#4D4946] leading-relaxed max-w-xl">
